...
class BotSpec extends Specification {
    ...
    def "go should make retweeter retweet a tweet"() {
        ...
        MastodonReposterFactory mastodonReposterFactory = Mock()
        Time time = Mock()
        ...
        Bot bot = new Bot(botConfigFactory, retweeterFactory, blueskyReposterFactory,
                mastodonReposterFactory,  time, pollTweetChooserFactory)
