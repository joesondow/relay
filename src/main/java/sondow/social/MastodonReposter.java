...
public class MastodonReposter {

    private final Logger log = Logger.getLogger(MastodonReposter.class);
     ...
     * @param mastodonConfig the configuration for the mastodon account whose post will be reposted
     * @param bluesky        the interface to the bluesky remote service
     */
    public MastodonReposter(Time time, MastodonConfig mastodonConfig, Bluesky bluesky) {
        this.time = time;
        this.mastodonConfig = mastodonConfig;
        this.bluesky = bluesky;
    }

    public MastodonReposter(MastodonConfig targetConfig) {
