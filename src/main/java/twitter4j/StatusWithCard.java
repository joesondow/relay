...
public interface StatusWithCard
        extends Comparable<StatusWithCard>, TwitterResponse, EntitySupport, java.io.Serializable {
     ...
     *
     * @return the text (e.g. Along with our new #Twitterbird, we've also updated our Display Guidelines:
     *         https://t.co/Ed4omjYs ^JC)
     */
    String getText();
    ...
    /**
     * Returns the number of times this tweet has been retweeted, or -1 when the tweet was created before this
     * feature was enabled.
     *
    ...
    /**
     * Returns true if the authenticating user has retweeted this tweet, or false when the tweet was created
    ...
    /**
     * Returns the authenticating user's retweet's id of this tweet, or -1L when the tweet was created before
    ...
    /**
     * Returns the Card object from the tweet, containing the twitter poll or some other display content.
     *
